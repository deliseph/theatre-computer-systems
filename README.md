...
- **53 interactive explainers**, placed inline where each idea is taught. Every one shows a real
...
- **A bilingual glossary**, 295 terms, English and 繁體中文.
...
| `glossary.md` | 295 terms, EN and 繁中 |
