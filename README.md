...
- **18 calculators**, each printing its working, because the exam awards method marks. Three
  of them (DIP switch, beam, power load) use the tested arithmetic from
  [showstack](https://github.com/deliseph/showstack), so the two cannot drift apart.
