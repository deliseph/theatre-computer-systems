...
export const readiness = {
  1: [
    ...
    { q: 'Sound travels roughly how far in one millisecond?',
      ...
      c: 0, fix: 'About 343 m/s, so roughly 3 ms per metre. It is on the reference card, Block 1.' },
    { q: 'Which is larger: one uncompressed HD video stream, or 64 channels of digital audio?',
      ...
      c: 0, fix: 'Video is about 2.5 Gbit/s and 64 audio channels about 74 Mbit/s. Read Foundations, the five calculations.' },
  ...
  2: [
    { q: 'A 1 Gbit/s network link moves roughly how many megabytes per second?',
      ...
      c: 0, fix: 'Networks are bits, storage is bytes. Divide by 8. Foundations, bits and bytes.' },
    { q: 'How many different values can 8 bits represent?',
      a: ['256', '8', '128', '65,536'],
      c: 0, fix: '2^8 = 256, which is why one DMX channel has 256 levels. Foundations, powers of two.' },
    { q: 'A drive is advertised at "up to 7,000 MB/s". Which word is missing?',
      a: ['Sustained', 'Encrypted', 'Sequential', 'Certified'],
      c: 0, fix: 'Marketing quotes burst. A show needs sustained. Foundations, reading a spec sheet.' },
    { q: 'Which of these is a container rather than a codec?',
      a: ['.mov', 'H.264', 'ProRes', 'HAP'],
      c: 0, fix: 'The container is the box, the codec is the compression method. Class 2 Block C.' },
  ...
  3: [
    { q: 'Which of these can NEVER appear as an octet in a subnet mask?',
      a: ['200', '192', '248', '254'],
      c: 0, fix: 'A mask is a solid run of ones. Learn the nine values in Foundations.' },
    { q: 'What is binary 11000000 in decimal?',
      a: ['192', '240', '128', '96'],
      c: 0, fix: '128 + 64 = 192. Foundations, binary in the only depth you need.' },
    { q: 'How many usable host addresses does a /26 give you?',
      a: ['62', '64', '30', '126'],
      c: 0, fix: '2^(32−26) − 2 = 62. The minus two is the network and broadcast addresses.' },
    { q: 'A device shows the address 169.254.11.7. What does that mean?',
      ...
      c: 0, fix: 'Link-local self-assignment: DHCP was expected and no server replied. Reference card, Block 3.' },
  ...
  4: [
    { q: 'Can 10.101.1.50/25 talk directly to 10.101.1.130/25?',
      ...
      c: 0, fix: 'A /25 splits at 128, so .50 and .130 are in different networks. Use the subnet tool.' },
    { q: 'One RGB pixel needs how many DMX channels?',
      a: ['3', '1', '4', '512'],
      c: 0, fix: 'Three, one per colour, so 170 RGB pixels fit in a universe. Foundations, calculation four.' },
    ...
    { q: '4,320 channels needs how many universes?',
      a: ['9', '8', '8.4', '10'],
      c: 0, fix: '4,320 ÷ 512 = 8.4, and you always round UP. Partial universes still cost a universe.' },
  ...
  5: [
    { q: 'Uncompressed 1080p60 10-bit 4:2:2 is roughly what data rate?',
      ...
      c: 0, fix: '1920 × 1080 × 60 × 20 bits. Redo the video calculation from Class 2.' },
    { q: 'IGMP snooping is enabled and there is no querier. What happens?',
      ...
      c: 0, fix: 'Group memberships time out, so it fails late. Revisit Class 3, multicast.' },
    { q: 'You pull the network cable. Which recovers by itself when you plug it back in?',
      ...
      c: 0, fix: 'State repeats constantly so it self-corrects; an event fired into a cut cable is gone. Class 4 Block A.' },
    { q: 'What does QoS do on a show network?',
      ...
      c: 0, fix: 'Priority, not capacity. Class 3, Block C.' },
